...
if (isset($_POST['email'])) {
  ...
  $userid = $user->getUserByEmailAndPassword($email);      // note the overloading

  if (!empty($userdata)) {
    $_SESSION['user'] = $userdata;
    $_SESSION['user']['id'] = $userid;
    helper::redirect("admin/category/category");
  } else {
...
<body class="hold-transition login-page">
  <div class="login-box">
    <div class="login-logo">
      <a href="design/back/index2.html"><b>Abdelrahman </b>dashboard</a>
    </div>
    <!-- /.login-logo -->
    <div class="card">
